...
- **if_warmup_or_cooldown_start (int):** 0 for warmup start, 0 for cooldown start. Decide whether to start with warmup or cooldown step.
...
- **if_post_warmup (int):** 0 for no post warmup, 1 for post warmup. Decide whether to have post warmup step, i.e. after first warmup.
...
```
![example1](./TEST/LRS-1.png "example1")
...
```
![example2](./TEST/LRS-2.png "example2")
...
```
![example3](./TEST/LRS-3.png "example3")
...
```
![example4](./TEST/LRS-4.png "example4")
